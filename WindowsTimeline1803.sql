...
SELECT -- This the ActivityOperation Table Query
	...
	case when ActivityOperation.ActivityType in (2,11,12,15) then ''
	...
	case when ActivityOperation.ActivityType not in (2,11,12,15) then 
  ...
  case when ActivityOperation.ActivityType not in (2,11,12,15) then json_extract(ActivityOperation.OriginalPayload, '$.appDisplayName') else ActivityOperation.OriginalPayload end as 'Original Displayed Name',
  case when ActivityOperation.ActivityType not in (2,11,12,15) then json_extract(ActivityOperation.OriginalPayload, '$.displayText') end as 'Original File/title opened',
  case when ActivityOperation.ActivityType not in (2,11,12,15) then json_extract(ActivityOperation.OriginalPayload, '$.description') end as 'Original Full Path /Url', 
  case when ActivityOperation.ActivityType not in (2,11,12,15) then coalesce(json_extract(ActivityOperation.OriginalPayload, '$.activationUri'),json_extract(ActivityOperation.OriginalPayload, '$.reportingApp')) end as 'Original_App/Uri',
  case when ActivityOperation.ActivityType not in (2,11,12,15) then time(json_extract(ActivityOperation.OriginalPayload, '$.activeDurationSeconds'),'unixepoch') end as 'Orig.Duration'
...
select -- This the Activity Table Query
   ...
   null as 'Order',  
   case when Activity.ActivityType in (2,11,12,15) then ''
	...
	case when Activity.ActivityType not in (2,11,12,15) then 
  ...
  case when Activity.ActivityType not in (2,11,12,15) then json_extract(Activity.OriginalPayload, '$.appDisplayName') else Activity.OriginalPayload end as 'Original Program Name',
  case when Activity.ActivityType not in (2,11,12,15) then json_extract(Activity.OriginalPayload, '$.displayText') end as 'Original File/title opened',
  case when Activity.ActivityType not in (2,11,12,15) then json_extract(Activity.OriginalPayload, '$.description') end as 'Original Full Path /Url',
  case when Activity.ActivityType not in (2,11,12,15) then coalesce(json_extract(Activity.OriginalPayload, '$.activationUri'),json_extract(Activity.OriginalPayload, '$.reportingApp')) end as 'Original_App/Uri',
  case when Activity.ActivityType not in (2,11,12,15) then time(json_extract(Activity.OriginalPayload, '$.activeDurationSeconds'),'unixepoch' ) end as 'Orig.Duration'
